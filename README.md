...
This project is a simulation of the **Producer–Consumer problem integrated with Virtual Memory management**, developed for the **Introduction to Operating Systems** course.
...
* Real-time output displays buffer state and memory usage
